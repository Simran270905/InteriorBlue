      ...
      <div className="max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          {data.projects.map((project, index) => (
            <motion.div
              key={project.id}
              className="bg-white rounded-md shadow-md overflow-hidden group cursor-pointer"
            ...
            >
              ...
              >
                <img
                  src={project.image}
                  alt={project.name}
                  className="h-64 w-full object-cover group-hover:brightness-110 transition-all duration-500"
                />
                <motion.div 
